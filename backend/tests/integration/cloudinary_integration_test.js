...
const log = (id, description, expected, actual, pass) => {
    if (pass) { P++; console.log(`âœ… ${id}: ${description}`); }
    else      { F++; console.error(`âŒ ${id}: ${description} | Expected: ${expected} | Got: ${actual}`); }
    rows.push(`| ${pass ? 'âœ…' : 'âŒ'} **${id}** | ${description} | ${expected} | ${actual} |`);
};
...
async function runIntegrationTests() {
    try {
        ...
        console.log("ðŸš€ Connected to MongoDB. Wiping & Seeding...\n");

        // â”€â”€ SETUP: Wipe and Seed â”€â”€
        ...
        for (const thread of allThreads) {
            for (const delUrl of deletedUrls) {
                if (thread.attachments && thread.attachments.includes(delUrl)) {
                    ghostFound = true;
                    console.error(`  âš ï¸ Ghost found in thread ${thread._id}: ${delUrl}`);
                }
            }
        }
        ...
        // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ CLEANUP â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ REPORT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
`;
        ...
        console.log(`\nðŸŽ‰ Integration test complete! Report: tests/integration/cloudinary_integration_result.md`);
        console.log(`\nðŸ“Š Score: ${P}/${P + F} passed`);
        process.exit(0);
